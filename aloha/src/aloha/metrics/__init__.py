...
from .chair import CHAIRMetrics
from .clipscore import CLIPScoreMetrics
from src.aloha.object_parser import Claude3OpusObjectParser, GPT35TurboObjectParser, SpacyObjectParser
from src.aloha.string_similarity import (
    GPT3EmbeddingSimilarity,
    MPNetSimilarity,
    StringMatchingSimilarity,
    Word2VecSimilarity,
)
from src.aloha.utils import partialclass
