...
from src.aloha.object_parser import GPT35TurboObjectParser, ObjectParser
from src.aloha.string_similarity import MPNetSimilarity, StringSimilarityMeasure
from src.aloha.utils import COCO_OBJECTS
